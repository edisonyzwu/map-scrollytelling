  ...
  chapters: [
    {
      ...
      description:
        "The trip often began with a one-way ticket from <strong>China</strong> to <strong>Ecuador</strong> — one of the few countries that allowed Chinese passport holders to enter <strong>without a visa</strong>. (That policy was later rescinded in July 2024).",
      location: {
...

    {
      ...
      showMarkers: true,
      description:
        "From there, they begin the journey north using intercity buses or smuggler-arranged vans, riding for hours through <strong>Ecuador</strong> to <span style='color: orange; padding: 0'><strong>Necoclí</strong></span>, a coastal town on Colombia’s Caribbean shore.",
      location: {
...

    {
      ...
      description:
        "<p>To enter Panama, they must cross the <span style='background-color: #8B0000; color: white; padding: 0 4px'><strong>Darién Gap</strong></span>—a lawless, roadless expanse of dense rainforest stretching more than <strong>100 kilometers</strong>, known as one of the most dangerous migration routes in the world.</p> <p>There were no roads, no signs, no guarantees, only smuggler-guided trails that twist through thick foliage, mudslides, steep ridges, and fast-moving rivers. </p>",
      location: {
        center: [-77.303, 8.533],
        zoom: 7,
        pitch: 0,
...

    {
      ...
      showMarkers: false,
      description:
        "Migrants carried whatever they could fit in a backpack and spent days hiking through slick trails, steep cliffs, and flooded ravines. The region was notorious for bandits, smugglers, venomous animals, and deadly dehydration. Some people didn’t make it out.",
      location: {
        center: [-77.303, 8.533],
        zoom: 7,
        pitch: 0,
...

    {
      ...
      description:
        "Those who survived the jungle continued north, crossing through <strong>Panama, Costa Rica, Nicaragua, Honduras,</strong> and <strong>Guatemala</strong>, before finally entering Mexico.",
      location: {
...

    {
      ...
      description:
        "Eventually, they reached <strong>Tijuana</strong>, just <span style='background: repeating-linear-gradient(45deg, #8B0000, #8B0000 5px, #8B3220 5px, #8B3220 10px); color: white; padding: 0 4px'><strong>a wall</strong></span> away from San Diego.",
      location: {
        center: [-117.046623, 32.522499],
        zoom: 11,
        pitch: 0,
